...
<div class="container-fluid py-4 text-start">
                ...
                <div class="info-pill text-secondary fw-medium">
                    Target: <span class="fw-bold text-dark">
                        @foreach($daftar_kelas as $kls)
                            @if(old('kelas_id', $kelasTerpilih) == $kls->id)
    ...
    <div class="card border-0 shadow-premium rounded-4 bg-white">
        <div class="card-body p-4">
            <form action="{{ route('siswa.simpan') }}" method="POST" class="needs-validation" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group search-merge-group">
                                ...
                                <select name="kelas_id" class="form-select shadow-none" style="padding: 10px 12px;">
                                    ...
                                    @foreach($daftar_kelas as $kls)
                                        <option value="{{ $kls->id }}" {{ old('kelas_id', $kelasTerpilih)==$kls->id ? 'selected' : '' }}>
                                            Kelas {{ $kls->nama_kelas }}
                                        </option>
                                    @endforeach
                                </select>
                    ...
                    <div class="col-md-5 ps-md-4">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="rfid-scanner-zone {{ old('rfid_code') ? 'active-card' : '' }} text-center">
                            ...
                            <div class="d-flex justify-content-between mt-1.5 px-1">
                                ...
                                <span class="fw-semibold xsmall text-dark" id="rfid-status" style="font-size: 0.78rem;">
                                    {{ old('rfid_code') ? 'Terbaca: '.old('rfid_code') : 'Kosong' }}
                                </span>
                            </div>
                        </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            <a href="{{ $kelasTerpilih ? route('kelas.show', $kelasTerpilih) : route('kelas.index') }}"
