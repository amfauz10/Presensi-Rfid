        ...
        <div class="row g-0">
            ...
            <div class="col-lg-5 d-flex flex-column justify-content-between p-4 p-sm-5 form-section">
                ...
                <div class="d-none d-lg-block mb-3">
                    {{-- <img src="{{ asset('assets/img/logo-sekolah.png') }}" alt="Logo" style="height: 45px;"> --}}
                </div>
                    ...
                    <form action="/proses-login" method="POST" autocomplete="off">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group search-merge-group">
                                ...
                                <input type="email" name="email" value="{{ old('email') }}" class="form-control shadow-none" placeholder="Contoh: admin@gmail.com" required autofocus>
                            </div>
                        </div>
                        
                        {{-- INPUT PASSWORD + FITUR TOGGLE MATA --}}
                        <div class="mb-3">
