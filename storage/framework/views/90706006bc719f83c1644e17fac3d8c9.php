...
<?php $__env->startSection('title', 'Edit Pengguna - SDN Tengah 03'); ?>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            <input
                                ...
                                class="form-control form-control-custom password-field <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <option value="guru" <?php echo e(old('role', $user->role) == 'guru' ? 'selected' : ''); ?>>
                                 Guru / Staf
                            </option>
                        </select>
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <?php $__currentLoopData = $kelas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option 
                                    ...
                                    <?php echo e(old('kelas_id', $user->kelas_id) == $k->id ? 'selected' : ''); ?>>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sistem-presensi\resources\views/users/edit.blade.php ENDPATH**/ ?>