        ...
        <div class="col-lg-7 col-md-9 text-center">
            ...
            <div class="card card-terminal shadow-2xl border-0">
                <div class="card-body p-5">
                    ...
                    <form action="<?php echo e(route('proses.tap')); ?>" method="POST" id="form-rfid">
                        <?php echo csrf_field(); ?>
                        <input type="text" name="rfid_code" id="rfid_input" class="hidden-input" autofocus autocomplete="off">
                    </form>

                    <div class="mt-4 pt-3 border-top">
                        <a href="<?php echo e(route('dashboard')); ?>" class="btn btn-link text-decoration-none text-secondary btn-sm fw-medium">
...
</html><?php /**PATH C:\xampp\htdocs\sistem-presensi\resources\views/presensi/terminal.blade.php ENDPATH**/ ?>