...
<div class="container-fluid mt-4 text-start">
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 mb-4">
        ...
        <div class="d-flex gap-2">
            ...
            <?php if($tahunAjaran->where('status',1)->count()): ?>
            <a
                href="<?php echo e(route('tahunajaran.kenaikan')); ?>"
            ...
            <div class="card card-premium bg-white p-3 h-100 position-relative overflow-hidden">
                <div class="card-body p-0 d-flex align-items-center justify-content-between">
                    <div>
                        ...
                        <h3 class="fw-bold text-success mb-0 font-monospace fs-2" style="letter-spacing: -1px;"><?php echo e($tahunAjaran->where('status',1)->count()); ?></h3>
                    </div>
            ...
            <div class="card card-premium bg-white p-3 h-100 position-relative overflow-hidden">
                <div class="card-body p-0 d-flex align-items-center justify-content-between">
                    <div>
                        ...
                        <h3 class="fw-bold text-dark mb-0 font-monospace fs-2" style="letter-spacing: -1px;"><?php echo e($tahunAjaran->count()); ?></h3>
                    </div>
            ...
            <div class="card card-premium bg-white p-3 h-100 position-relative overflow-hidden">
                <div class="card-body p-0 d-flex align-items-center justify-content-between">
                    <div>
                        ...
                        <h3 class="fw-bold text-secondary mb-0 font-monospace fs-2" style="letter-spacing: -1px;"><?php echo e($tahunAjaran->where('status',0)->count()); ?></h3>
                    </div>
                ...
                <div class="card-body px-4 pb-4 pt-0">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover align-middle mb-0">
                            ...
                            <tbody id="tbodyTahun">
                            <?php $__empty_1 = true; $__currentLoopData = $tahunAjaran; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td class="text-center text-muted fw-medium"><?php echo e($loop->iteration); ?></td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2 text-dark">
                                            <span class="font-monospace small bg-light border px-2 py-0.5 rounded"><?php echo e(\Carbon\Carbon::parse($item->tanggal_mulai)->format('d M Y')); ?></span>
                                            <span class="text-muted small text-uppercase fw-semibold" style="font-size: 0.7rem;">s/d</span>
                                            <span class="font-monospace small bg-light border px-2 py-0.5 rounded"><?php echo e(\Carbon\Carbon::parse($item->tanggal_selesai)->format('d M Y')); ?></span>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center gap-2">
                                            <?php if(!$item->status): ?>
                                            <form action="<?php echo e(route('tahunajaran.aktifkan',$item->id)); ?>" method="POST" class="m-0 saas-aktifkan-form" data-tahun="<?php echo e($item->nama); ?>">
                                                <?php echo csrf_field(); ?>
                                            ...
                                            <form action="<?php echo e(route('tahunajaran.destroy',$item->id)); ?>" method="POST" class="m-0">
                                                <?php echo csrf_field(); ?>
                                            ...
                                            <?php if($item->status): ?>
                                            <a href="<?php echo e(route('tahunajaran.kenaikan')); ?>" class="btn btn-link p-0 text-primary shadow-none" title="Kelola Kenaikan Kelas">
                                ...
                                <div class="modal fade" id="edit<?php echo e($item->id); ?>" tabindex="-1" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <form action="<?php echo e(route('tahunajaran.update', $item->id)); ?>" method="POST">
                                                <?php echo csrf_field(); ?>
                                                <?php echo method_field('PUT'); ?>
                                                ...
                                                <div class="modal-body text-start">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="nama" class="form-control shadow-none" value="<?php echo e($item->nama); ?>" required>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label fw-semibold text-muted small text-uppercase">Tanggal Mulai</label>
                                                        <input type="date" name="tanggal_mulai" class="form-control shadow-none" value="<?php echo e($item->tanggal_mulai); ?>" required>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label fw-semibold text-muted small text-uppercase">Tanggal Selesai</label>
                                                        <input type="date" name="tanggal_selesai" class="form-control shadow-none" value="<?php echo e($item->tanggal_selesai); ?>" required>
                                                    </div>
                                                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sistem-presensi\resources\views/tahunajaran/index.blade.php ENDPATH**/ ?>