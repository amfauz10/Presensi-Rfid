        ...
        <div class="col-lg-5">
            <div class="card-custom h-100 p-0 overflow-hidden rounded-4">
                ...
                <div class="p-4" style="max-height:380px; overflow-y:auto;">
                    <?php $__empty_1 = true; $__currentLoopData = $daftar_kelas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kelasStats): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <?php
                        ...
                        <div class="mb-4">
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                <span class="fw-bold text-dark" style="font-size: 0.9rem;">Kelas <?php echo e($kelasStats->nama_kelas); ?></span>
                                <span class="badge text-primary bg-primary bg-opacity-10 px-2.5 py-1.5 rounded-pill font-monospace" style="font-weight:700; font-size:11px; min-width:85px; text-align:center;">
                                    <?php echo e($hadir); ?> / <?php echo e($total); ?> Murid
                                </span>
                            </div>
                            <div class="progress" style="height:8px; background:#f1f5f9; border-radius:20px;">
                                <div class="progress-bar bg-primary" role="progressbar" style="width: <?php echo e($persen); ?>%; border-radius:20px;" aria-valuenow="<?php echo e($persen); ?>" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                        </div>
...
<?php /**PATH C:\xampp\htdocs\sistem-presensi\resources\views/dashboard/admin.blade.php ENDPATH**/ ?>