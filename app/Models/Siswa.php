...
class Siswa extends Model
{
    ...
    protected $fillable = [
        ...
        'nama_siswa', 
        'rfid_code', 
        'nama_orang_tua',   // SINKRONISASI: Wajib ada agar data dari SiswaImport tidak diblokir Laravel
     ...
     * Menghubungkan identitas siswa ke rekap jejak presensi harian.
     * Catatan Evaluasi: Relasi ini berjalan optimal jika rfid_code siswa tidak NULL.
     * Jika siswa tidak punya kartu RFID, pastikan rfid_code diisi 'MANUAL_' + ID Siswa 
     * saat proses Create/Insert Data Siswa.
     */
    public function presensi(): HasMany
    {
        return $this->hasMany(Presensi::class, 'rfid_code', 'rfid_code');
    }
